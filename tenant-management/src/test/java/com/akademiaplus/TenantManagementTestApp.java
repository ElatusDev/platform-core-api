...
/**
 * Minimal Spring Boot application class for tenant-management integration tests.
 *
 ...
 * utilities) alongside tenant-management's own beans.
 *
 ...
 * cannot be instantiated outside a web request context. The test-jar
...
public class TenantManagementTestApp {
}
