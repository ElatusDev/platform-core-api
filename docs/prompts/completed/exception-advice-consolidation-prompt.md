...
**Spec**: `docs/design/exception-advice-strategy.md`
...
Read the exact handler implementations from **Section 6.1** of `docs/design/exception-advice-strategy.md`. The class must:
