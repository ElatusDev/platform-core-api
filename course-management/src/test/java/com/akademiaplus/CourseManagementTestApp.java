...
/**
 * Minimal Spring Boot application class for course-management integration tests.
 *
 ...
 * utilities, user-management) alongside course-management's own beans.
 *
...
public class CourseManagementTestApp {
}
