...
/**
 * Handles soft-deletion of a {@link ScheduleDataModel} by composite key.
 * <p>
...
public class DeleteScheduleUseCase {
    ...
    public DeleteScheduleUseCase(ScheduleRepository repository,
    ...
    /**
     * Soft-deletes the {@link ScheduleDataModel} identified by the given ID
     * within the current tenant context.
     *
     * @param scheduleId the entity-specific ID
