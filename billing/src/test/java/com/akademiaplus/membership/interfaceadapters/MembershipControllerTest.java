...
class MembershipControllerTest {
    ...
    @Mock private DeleteMembershipUseCase deleteMembershipUseCase;
    ...
    @BeforeEach
    void setUp() {
        MembershipController controller = new MembershipController(creationUseCase, getAllUseCase, getByIdUseCase, deleteMembershipUseCase);
    ...
    class CreateMembership {
        ...
        void shouldReturn201_whenMembershipCreatedSuccessfully() throws Exception {
            ...
            verifyNoMoreInteractions(creationUseCase, getAllUseCase, getByIdUseCase, deleteMembershipUseCase, messageService);
        }
    }
    ...
    class GetMembershipById {
        ...
        void shouldReturn200_whenFound() throws Exception {
            ...
            verify(getByIdUseCase, times(1)).get(MEMBERSHIP_ID);
            verifyNoMoreInteractions(creationUseCase, getAllUseCase, getByIdUseCase, deleteMembershipUseCase, messageService);
        }
        ...
        void shouldReturn404_whenNotFound() throws Exception {
            ...
            verify(getByIdUseCase, times(1)).get(MEMBERSHIP_ID);
            verify(messageService, times(1)).getEntityNotFound(EntityType.MEMBERSHIP, String.valueOf(MEMBERSHIP_ID));
            verifyNoMoreInteractions(creationUseCase, getAllUseCase, getByIdUseCase, deleteMembershipUseCase, messageService);
        }
    }
}
