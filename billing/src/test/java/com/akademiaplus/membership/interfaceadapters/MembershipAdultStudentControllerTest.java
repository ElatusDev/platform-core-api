...
class MembershipAdultStudentControllerTest {
    ...
    @Mock private DeleteMembershipAdultStudentUseCase deleteMembershipAdultStudentUseCase;
    ...
    void setUp() {
        MembershipAdultStudentController controller = new MembershipAdultStudentController(
                creationUseCase, getAllUseCase, getByIdUseCase, deleteMembershipAdultStudentUseCase);
    ...
    class CreateMembershipAdultStudent {
        ...
        void shouldReturn201_whenMembershipAdultStudentCreatedSuccessfully() throws Exception {
            ...
            verifyNoMoreInteractions(creationUseCase, getAllUseCase, getByIdUseCase, deleteMembershipAdultStudentUseCase, messageService);
        }
    }
    ...
    class GetMembershipAdultStudentById {
        ...
        void shouldReturn200_whenFound() throws Exception {
            ...
            verify(getByIdUseCase, times(1)).get(MEMBERSHIP_ADULT_STUDENT_ID);
            verifyNoMoreInteractions(creationUseCase, getAllUseCase, getByIdUseCase, deleteMembershipAdultStudentUseCase, messageService);
        }
        ...
        void shouldReturn404_whenNotFound() throws Exception {
            ...
            verify(getByIdUseCase, times(1)).get(MEMBERSHIP_ADULT_STUDENT_ID);
            verify(messageService, times(1)).getEntityNotFound(EntityType.MEMBERSHIP_ADULT_STUDENT, String.valueOf(MEMBERSHIP_ADULT_STUDENT_ID));
            verifyNoMoreInteractions(creationUseCase, getAllUseCase, getByIdUseCase, deleteMembershipAdultStudentUseCase, messageService);
        }
    }
}
