...
/**
 * Handles soft-deletion of a {@link CompensationDataModel} by composite key.
 * <p>
 ...
 */
@Service
public class DeleteCompensationUseCase {

    private final CompensationRepository repository;
    private final TenantContextHolder tenantContextHolder;

    public DeleteCompensationUseCase(CompensationRepository repository,
    ...
    /**
     * Soft-deletes the {@link CompensationDataModel} identified by the given ID
     * within the current tenant context.
     *
     * @param compensationId the entity-specific ID
