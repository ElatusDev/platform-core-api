...
/**
 * Handles soft-deletion of a {@link MembershipDataModel} by composite key.
 * <p>
...
public class DeleteMembershipUseCase {
    ...
    public DeleteMembershipUseCase(MembershipRepository repository,
    ...
    /**
     * Soft-deletes the {@link MembershipDataModel} identified by the given ID
     * within the current tenant context.
     *
     * @param membershipId the entity-specific ID
