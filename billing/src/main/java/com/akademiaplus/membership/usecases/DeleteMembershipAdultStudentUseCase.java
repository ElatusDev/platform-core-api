...
/**
 * Handles soft-deletion of a {@link MembershipAdultStudentDataModel} by composite key.
 * <p>
 ...
 */
@Service
public class DeleteMembershipAdultStudentUseCase {

    private final MembershipAdultStudentRepository repository;
    private final TenantContextHolder tenantContextHolder;

    public DeleteMembershipAdultStudentUseCase(MembershipAdultStudentRepository repository,
    ...
    /**
     * Soft-deletes the {@link MembershipAdultStudentDataModel} identified by the given ID
     * within the current tenant context.
     *
     * @param membershipAdultStudentId the entity-specific ID
     ...
     */
    @Transactional
    public void delete(Long membershipAdultStudentId) {
        ...
        DeleteUseCaseSupport.executeDelete(
                ...
                EntityType.MEMBERSHIP_ADULT_STUDENT,
                String.valueOf(membershipAdultStudentId));
    }
}
