...
/**
 * Handles soft-deletion of a {@link NotificationDataModel} by composite key.
 * <p>
...
public class DeleteNotificationUseCase {
    ...
    public DeleteNotificationUseCase(NotificationRepository repository,
    ...
    /**
     * Soft-deletes the {@link NotificationDataModel} identified by the given ID
     * within the current tenant context.
     *
     * @param notificationId the entity-specific ID
